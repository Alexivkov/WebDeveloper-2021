...
- *3.2 Making Layouts* 
  ...
  - *Flexboxes:*
    - https://www.w3.org/TR/css-flexbox-1/#valdef-display-inline-flex
...
- *4.2 Javascript - Learn DOM Manipulation*
  ...
  - DOM events https://learn.javascript.ru/events
...
### 7. CSS Architecture and Preprocessors

- *7.1 BEM 

  - documentation https://ru.bem.info/methodology/
